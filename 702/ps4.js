...
function toggle_payload(pld){
	...
	}else if(pld == "restore702bin"){
		document.getElementById("progress").innerHTML="Loading Restore.. Please wait..";
		preloadScripts(['jb.js', 'preloader.js', 'restore702bin.js', 'loader.js']);
	}else if(pld == "restore702old"){
		document.getElementById("progress").innerHTML="Loading Restore.. Please wait..";
		preloadScripts(['jb.js', 'preloader.js', 'restore702old.js', 'loader.js']);
	}
