...
function toggle_payload(pld){
	if(pld == "restore7jb"){
		...
		preloadScripts(['jb.js', 'preloader.js', 'restore7jb.js', 'loader.js']);
	}else if(pld == "restore755"){
		document.getElementById("progress").innerHTML="Loading Payload.. Please wait..";
		preloadScripts(['jb.js', 'preloader.js', 'restore755.js', 'loader.js']);
	}else if(pld == "restore75x"){
		document.getElementById("progress").innerHTML="Loading Payload.. Please wait..";
		preloadScripts(['jb.js', 'preloader.js', 'restore75x.js', 'loader.js']);
	}
